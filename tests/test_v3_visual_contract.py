...
exterior=Path("ui-v6/src/product-v3-exterior.svg").read_text(encoding="utf-8")
...
for visual in ("v3-material-cup","v3-material-housing","v3-material-base","v3-control-panel","v3-thermal-covers","v3-exterior-vent","v2-thermal-interface","v2-peltier-pair","v2-temperature-probes","v2-electronics-deck","v2-cut-fan"):
...
assert 'viewBox="205 75 500 680"' in exterior and 'viewBox="175 72 570 666"' in cutaway

...
PREVIEW_CONTROLS = """
<div class="preview-console" aria-label="Lokale Vorschau-Szenarien">
 ...
 <button type="button" data-scenario="disconnected">DISCONNECT</button>
...
def compose(*, preview: bool, minified: bool) -> tuple[str, str, str]:
    ...
    scripts = [read("thermal-field.js")]
    if preview:
        scripts.append(read("preview.js"))
    scripts.append(read("dashboard.js").replace("__PREVIEW_MODE__", "true" if preview else "false"))
    javascript = "\n\n".join(scripts)
    if minified:
        css = minify_css(css)
...
def build_stats(preview_html: str, production_html: str, css: str, javascript: str) -> dict:
    ...
    return {
        ...
        "thermal_field_frame_cap_fps": 30,

...
def compose(*, preview: bool, minified: bool) -> tuple[str, str, str]:
    ...
    cutaway = cutaway.replace("__PRODUCT_CUTAWAY__", image_data(V5_SOURCE / "product-finished-cutaway-v2.webp"))
    cutaway = cutaway.replace("__PCB_ORIGINAL__", image_data(V5_SOURCE / "pcb-top-original.webp"))
...
def build_stats(preview_html: str, production_html: str, css: str, javascript: str) -> dict:
    ...
    return {
        ...
        "product_rendering": "embedded_photoreal_webp_with_individual_hardware_layers",

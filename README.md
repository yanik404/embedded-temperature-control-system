...
1. **Aufbau:** hochwertige, sofort sichtbare Produktvisualisierung auf Basis der gelieferten STEP-Geometrie. **AUSSEN** zeigt das glaubwürdig fertig montierte Gerät unverändert mit mattem Gehäuse, tief eingesetztem Becher, Peltierkontakten auf Becherhöhe sowie OLED und vier physischen Tastern in der unteren Frontaussparung. **INNEN** ist ein einziges einheitliches fotorealistisches Cutaway derselben Hülle. Dadurch teilen Peltier links/rechts, seitlicher TMP36, gefederter TMP36 unter dem Becher, mechanischer Becherschalter, genau ein horizontaler Lüfter, das originale runde 80-mm-PCB mit montiertem Pico W, der untere Lichtsensor sowie OLED und Taster dieselbe Perspektive, Beleuchtung und gegenseitige Verdeckung. Es gibt keine sichtbar aufgeklebten SVG-Bauteile mehr. Die Komponentenliste behält ihre kleinen Formschlüssel; unsichtbare, exakt platzierte Hotspots ermöglichen Fokus und Callout-Linie, ohne den normalen Produktblick zu stören. Auf Mobilgeräten stehen Produkt und Legende untereinander, ohne Callout-Linien. Die Visualisierung benötigt weder WebGL noch externe Assets.
...
- `ui-v5/src/product-finished-cutaway-v2.webp` – aktive einheitliche fotorealistische Schnittansicht mit allen Interna in gemeinsamer Perspektive

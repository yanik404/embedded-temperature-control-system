...
1. **Aufbau:** hochwertige, sofort sichtbare Produktvisualisierung auf Basis der gelieferten STEP-Geometrie. **AUSSEN** zeigt das glaubwürdig fertig montierte Gerät unverändert mit mattem Gehäuse, tief eingesetztem Becher, Peltierkontakten auf Becherhöhe sowie OLED und vier physischen Tastern in der unteren Frontaussparung. **INNEN** wurde als heller, offener CAD-Schnitt vollständig neu aufgebaut. Der dreipolige TMP36 sitzt sichtbar in einer seitlichen Kontaktaufnahme, der zweite TMP36 auf dem gefederten Kontakt direkt unter dem Becher. Der seitlich verschraubte dreipolige Mikroschalter ragt mit seinem langen Metallhebel zum Becher und wird beim Einschieben betätigt. Ein klarer 5-mm-Fototransistor sitzt unten im eigenen Lichtfenster. Peltier-Kontakte, genau ein horizontaler Lüfter, das gelieferte runde 80-mm-PCB mit montiertem Pico W, OLED und Taster bilden räumlich getrennte Ebenen. Das Original-PCB wurde aus der gelieferten 3D-Ansicht perspektivisch in die Baugruppe projiziert; seine reale Leiterbahn- und Bauteilanordnung bleibt erkennbar. Über **GESAMT**, **THERMIK**, **SENSORIK** und **ELEKTRONIK** wird der gewünschte Funktionsbereich hervorgehoben. Ein Klick auf ein Bauteil dunkelt die Umgebung ab, zeigt den exakten Bildausschnitt hell und öffnet eine vergrößerte Bauteil-Fokuskarte mit Typ und Einbauort. Die Hervorhebung verwendet ausschließlich gemessene Ausschnitte desselben Rasters; es gibt keine aufgeklebten Komponentenbilder. Auf Mobilgeräten stehen Produkt und Legende untereinander, ohne Callout-Linien. Die Visualisierung benötigt weder WebGL noch externe Assets.
